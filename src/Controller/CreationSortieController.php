...
{
    public const ETAT_CREE = 79;
    public const ETAT_OUVERTE = 80;
    public const ETAT_CLOTUREE = 81;
    public const ETAT_EN_COURS = 82;
    public const ETAT_PASSEE = 83;
    public const ETAT_ANNULEE = 84;
